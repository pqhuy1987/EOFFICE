...
$(document).ready(function (e) {
    ...
    $("#btnHieuChinh").click(function () {
        ...
        if (listChecked.length == 1) {
            ...
            return $(this).attr("href", $(this).attr('href') + '/?madangky=' + encodeURIComponent(ID)); //Encoder.htmlDecode(ID)
        }
        else
        {
...
function GetData(isHeader, mpb, stt) {
    ...
    fncGetData(linkContent + 'Home/SelectRows_DSDangkyvpp', DataJson, isHeader);
}

...
function GetData(isHeader) {
    ...
    var machamcong = $('#txtmachamcong').val();

    var phongban_congtruong = $('#txtphongban_congtruong').val();
    ...
    var DataJson = "{'ngaylamviectu':'" + tungay + "'," +
                     ...
                     "'thang':'" + thang + "'" +
                   "}";
    fncGetData_Timekeeping_Edit(linkContent + 'Timekeeping/SelectRows_themmoi', DataJson, isHeader);
}

function GetData_Edit(isHeader) {
    debugger;
    ...
    var DataJson = "{'ngaylamviectu':'" + tungay + "'," +
                     ...
                     "'thang':'" + thang + "'" +
                   "}";
    fncGetData_Timekeeping_new(linkContent + 'Timekeeping/SelectRows_themmoi_Edit', DataJson, isHeader);
}
